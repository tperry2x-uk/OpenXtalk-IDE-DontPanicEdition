...
> found in the Documentation Format Reference. This data will
> also appear in the dictionary.

#### Importing libraries
The Builder syntax is broken down into **modules**. There are 3
classes of module:

Type|Description
---|---
Default|These modules are part of Builder and are included by default. Their syntax is always available to you as a developer.
...
com.livecode.unittest|Default|Contains syntax for unit testing Builder programs.
...
pseudo-randomly generated UUID as a string:
	...
	*/
	...
	// Library public handler - this will be accessible
...
xTalks languages typically provide an external interface which allows you to extend it
