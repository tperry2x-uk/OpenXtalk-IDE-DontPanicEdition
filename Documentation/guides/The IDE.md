...
This guide details the main components within the Integrated
...
| Menu Item | Action |
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **New Stack**                          | Opens a cascading menu you can use to choose a stack type to create. When you save the stack, it asks for a file name and location.                                                                                                                 |
...
| **Open Stack...**                      | Opens the main stack whose file you select. If you select a HyperCard file, it is automatically converted into a main stack.                                                                                                                     |
...
| **Exit**                               | Closes all open stacks and quits.                                                                                                                                                                                                                |
...
| **Cut, Copy, Paste** | Cuts, copies or pastes the selected text or object. Text and images can be exchanged with other programs in this manner. Objects are only available within the currently running instance of the engine.                                                                                |
...
The Tools menu contains commands to work with the IDE's tool palettes
...
| **Extension Builder**      | Shows or hides the Extension Builder. The Extension Builder is a stack which aids in the creation of widget and library extensions. For more information on creating extensions using the Extension Builder, please see the *Extending* guide. |
...
| **Link**               | Makes the selected text, or all text in the selected object into a link. Linked text has special properties, for example linked text will receive a linkClicked message when clicked on. For more details, see the section on the *Field* object.                                 |
...
| **Suppress Errors**       | Prevents display of the error window when the IDE encounters a script error. |
...
| **Suspend Development Tools** | Hides the IDE's menus, palettes, and other parts of the development environment, so that you can preview how your application will look and behave as a standalone, outside the development environment. |

> **Caution:** Suppressing errors will cause your scripts to fail
silently instead of giving an error message in the event the IDE
encounters an error.

> **Tip:** To also suspend libraries, hold down the Shift key
...
| **Palettes**                      | Shows or hides all open palettes.                                                                                                                                                                                                                                                                                                                           |
...
| **Backdrop**                      | Shows or hides a solid or patterned backdrop behind the IDE's windows.                                                                                                                                                                                                                                                                                              |
| **Show IDE Stacks in Lists**      | If this item is checked, elements of the development environment appear in lists: for example, development environment stacks appear in the Application Browser, and custom properties appear in the Custom Properties pane of the property inspector. If unchecked, elements of the development environment do not appear in such lists. |
...
using the IDE and XTalk.

| Menu Item | Action |
|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Dictionary (API)**    | Opens the main documentation window, where you can get information about all aspects of developing.                                                                                                                                       |
...
| **All Guides**          | Opens the main documentation window, which contains all of the user guides	                                                         																												   |
| **Tutorials**           | Launches the online lessons portal in an external browser                                                      																																	   |
| **User Guide**          | Opens the old user guide in an external PDF viewer                                                   																			                                                         					   |
| **Forums**              | Navigates to the discussion forums in an external browser                                                  																			                                                         	   |
| **Technical Questions** | Navigates to questions tagged on StackOverflow in an external browser                                                 																			                                                       |
| **Discussion List**     | Navigates to the discussion list in an external browser                                                  																			                                                         		   |
| **Newsletters**         | Navigates to news letters and blogs in an external browser                                                  																			                                                         	   |
...
| **Support…**            | Loads the support section of the web site in your web browser.                                                                                                                                                                                                                                                                                                                                  |
...
| **Property description** 	| This text describes the object property. By default this text is an English-like description of the property. However you can change this to contain the name of the property in the Preferences or the settings menu. You may prefer to view the property names if you are writing scripts that set object properties.                                                                                                                                                          |
...
> script property equivalent. Then look that term up in the
> Dictionary.
...
| **Property labels**  | Controls whether to use the script tokens for property labels or not. |

## The Script Editor

The Script Editor within the IDE has been designed specifically for
xTalk coding. It includes features to help make code more
...
a script, see the section on Coding. The Script Editor will
...
| **Quit**    | Exits the IDE. Will prompt you to save your work if applicable. |
...
> **Note:** Autocomplete is currently unavailable in OpenXTalk
...
> **Tip:** The Message Box is one of the more useful components
>  when you are starting out and wanting to try out simple
...
to global properties take effect immediately. The Show IDE UI
Variables is an advanced option, discussed in the section on Editing the
IDE User Interface. For more details on Global Variables, see the
...
Show IDE UI Messages is an advanced option, discussed in the
section on *Editing the IDE User Interface*.
...
Show IDE UI Scripts is an advanced option that displays all of the
libraries used by the IDE. This is discussed in the section on
*Editing the IDE User Interface*.
...
| **Obey dontSearch properties**           | Specifies that fields, cards or groups with their dontSearch property set to true should be excluded from the search. For more details on the *dontSearch* property, see the Dictionary.                                                               |
| **Search marked or unmarked cards only** | Specified that the search should be restricted to either marked or unmarked cards. For more details on marked and unmarked cards, see *mark* in the Dictionary.                                                                                        |
...
| **All Other**                            | Searches all other commonly used object properties. For more details on exactly what is included, see the *properties* entry in the Dictionary.                                                                                                        |
