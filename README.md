MY NOTE: IDE from "IDE Bundle/Contents/Tools" works on Windows and Linux, it compile your livecode or oxtstack scripts to executable for win, lin, macos and android (just apk for now)...
